...
export class AppService {
  public baseUrl = 'http://api.meeting-planner.online/api/v1';
  ...
  public getMeetingDetails(meetingId, authToken): Observable<any> {
    return this._http.get(
      `${this.baseUrl}/meetings/${meetingId}/details?authToken=${authToken}`
    );
  } //end getUsers function
  ...
  public updateMeeting(data): Observable<any> {
    ...
    return this._http.put(
      `${this.baseUrl}/meetings/${data.meetingId}/updateMeeting`,
      params
    );
  } //end addMeeting
  ...
  public getUserAllMeeting(userId, authToken): Observable<any> {
    return this._http.get(
      `${this.baseUrl}/meetings/view/all/meetings/${userId}?authToken=${authToken}`
    );
  } //end getUsers function
  ...
  public deleteMeeting(meetingId, authToken): Observable<any> {
    ...
    return this._http.post(
      `${this.baseUrl}/meetings/${meetingId}/delete`,
      params
    );
  } //end deleteMeeting
  ...
  public sentMeetingReminders(userId, authToken): Observable<any> {
    ...
    return this._http.post(
      `${this.baseUrl}/meetings/admin-meetings/sentReminders`,
      params
    );
  } //end signIn
}
